...
class SettingsPanel extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.updateContent(); // Initial i18n application
    }
    ...
    updateContent() {
        ...
        this.shadowRoot.querySelector('.header h2').textContent = i18n.t(`settings.${this.activeTab}`);
    }
    ...
    switchTab(tabName) {
        ...
        // Update header title
        this.shadowRoot.querySelector('.header h2').textContent = i18n.t(`settings.${tabName}`);
    }
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .close-btn {
                    ...
                    padding: 0.5rem; color: var(--color-text-light);
                }
                .tabs {
                    display: flex;
                    background-color: var(--container-color);
